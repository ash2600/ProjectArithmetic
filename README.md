...
be added at the last element of the array, and all previous values will be shifted one place left. The first value will be lost, as we have to analyze the performance
  of the last six gammes only.and all previous values will be shifted one place left. the first value will be lost, as we have to analyze the prformance </li>
...
<li><b>dataPrep</b> method generates a data-frame AKA two-dimensional array to be passed to the getSlope method. method generates a data-frame AKA two-dimensional array to be passed to the getSlope method.</li>
